		...
		if (rule == null) {
			...
			try {
				if (isPreTokenization) {
					...
					assertArrayEquals(new Object[]{"Women's_rihgt" }, runtest("Women's_rihgt"));
					assertArrayEquals(new Object[]{"Akita Shoten Champion Red" }, runtest("Akita Shoten's Champion Red"));
