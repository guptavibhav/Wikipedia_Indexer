...
public class LocalDictionaryTest extends PropertiesBasedTest {
	...
	public final void testQuery() {
		...
		for (INDEXFIELD fld : testarr) {
			...
			String[] myterms = {"test","best","crest","zest","testy","tether","temper", "teat","tempest","aaabbb",".+aa",".+aaa"};
			...
			assertNull(dict.query("aaa?bbb") );
			assertNull(dict.query("?aaabbb") );
			assertNull(dict.query("aaabbb?") );
			
			assertArrayEquals(new Object[] {"aaabbb"}, getSortedArray(dict.query("?aabbb")));
			assertArrayEquals(new Object[] {"aaabbb"}, getSortedArray(dict.query("aaabb?")));
			assertArrayEquals(new Object[] {"aaabbb"}, getSortedArray(dict.query("aaabb?")));
			assertArrayEquals(new Object[] {".+aa"}, getSortedArray(dict.query(".+aa")));
			assertArrayEquals(new Object[] {".+aaa"}, getSortedArray(dict.query(".+aaa")));
			assertArrayEquals(new Object[] {".+aaa"}, getSortedArray(dict.query("?+aaa")));
