...
public class WikipediaParserTest {
	...
	public final void testParseListItem() {
		...
		//definition list
		assertEquals("afgj definition item", WikipediaParser.parseListItem("; afgj : definition item"));
	...
	public final void testParseTemplates() {
		assertEquals("<nowiki>{{UK-singer-stub}}</nowiki>", WikipediaParser.parseTemplates("<nowiki>{{UK-singer-stub}}</nowiki>"));
		assertEquals("<nowiki>{{UK-singer-stub}}</nowiki>", WikipediaParser.parseTemplates("<nowiki>{{UK-singer-stub}}</nowiki>{{UK-singer-stub}}"));
	...
	public final void testParseLinks() {
		...
		assertEquals(new Object[]{"[[Example]]",""}, WikipediaParser.parseLinks("[<nowiki />[[Example]]]"));
		assertEquals(new Object[]{"[[Example]]",""}, WikipediaParser.parseLinks("[[<nowiki />Example]]"));
	}
